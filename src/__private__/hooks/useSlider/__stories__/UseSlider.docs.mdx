...
- [Примеры компонентов со слайдером](#примеры-компонентов-со-слайдером)
...
## Примеры компонентов со слайдером

Посмотреть примеры работы слайдера с разными компонентами можно в разделе масштабирование:
- [Area](?path=/docs/components-area--playground)
- [DualAxes](?path=/docs/components-dualaxes--playground)
- [Line](?path=/docs/components-line--playground)
