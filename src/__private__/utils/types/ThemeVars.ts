...
export type ThemeVars = {
  color: {
    primary: { [key in VarsDefault['color']['primary'][number]]: string }
    accent: { [key in VarsDefault['color']['accent'][number]]: string }
    invert: { [key in VarsDefault['color']['invert'][number]]: string }
  }
  control: { [key in VarsDefault['control'][number]]: string }
  font: { [key in VarsDefault['font'][number]]: string }
  size: { [key in VarsDefault['size'][number]]: string }
  space: { [key in VarsDefault['space'][number]]: string }
}
