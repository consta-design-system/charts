import { BarExample, BarExampleSimple, BarExampleLabel, BarExampleSeriesField } from './examples/BarExample/BarExample'
...
Если нужно расположить столбцы вертикально, используйте [Column](/?path=/docs/components-Column--playground).
