import { ColumnExample, ColumnExampleSimple, ColumnExampleLabel, ColumnExampleSeriesField } from './examples/ColumnExample/ColumnExample'
...
Если нужно расположить столбцы горизонтально, используйте [Bar](/?path=/docs/components-Bar--playground).
