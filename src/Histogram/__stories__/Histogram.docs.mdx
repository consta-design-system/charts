import { HistogramExampleBasic, HistogramExampleSuperBasic } from './examples/HistogramExampleBasic/HistogramExampleBasic'
import { HistogramExampleStacked } from './examples/HistogramExampleStacked/HistogramExampleStacked'
import { HistogramExampleBoxesNumber, HistogramExampleBoxesWidth  } from './examples/HistogramExampleBoxes/HistogramExampleBoxes'
