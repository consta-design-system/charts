...
<Meta title="Документация/Создание кастомных графиков" id="common-charts" parameters={{ order: 200 }} />

# Создание новых графиков

Здесь мы расскажем, как подключить стилизованую под Consta тему для графиков, которых нет в
@сonsta/charts, но есть в [G2Plot](https://g2plot.antv.vision/en).
